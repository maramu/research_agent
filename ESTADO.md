...
| `utils/export_refs.py` | Genera BibTeX, RIS y CSV desde lista de dicts de `papers_metadata.jsonl`. Funciones: `load_papers`, `to_bibtex`, `to_ris`, `to_csv_str`, `build_papers_zip` (ZIP en memoria con PDFs y/o md_clean) | ✅ |
